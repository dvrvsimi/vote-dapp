// src/components/verify/VerificationForm.tsx
'use client';
...
const AGREEMENTS = [
  {
    ...
    content: "I agree to follow all election rules and guidelines, including voting limitations and ethical conduct requirements.",
  },
  {
    id: "responsibility",
    title: "Voter Responsibility",
    content: "I understand my responsibility to cast informed votes and maintain the integrity of the election process.",
  },
  {
    id: "privacy",
    title: "Privacy Policy",
    content: "I acknowledge that my voting records will be stored on the blockchain while maintaining my privacy in accordance with the system's design.",
  },
];
...
export function VerificationForm() {
  ...
  const { verifyUser, isLoading: isVerifying, fetchVerification } = useUserVerification();
  ...
  const handleVerification = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        } else if (err.toString().includes("Attempt to debit an account but found no record of a prior credit")) {
          setError("This wallet is new, has a zero balance, and needs funding to carry out transactions.");
        } else {
